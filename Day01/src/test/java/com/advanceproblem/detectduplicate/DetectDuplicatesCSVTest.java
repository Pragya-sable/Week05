package com.advanceproblem.detectduplicate;
import com.advanceproblem.converjsontocsv.detectduplicate.DetectDuplicateInCSVExample;
...
public class DetectDuplicatesCSVTest {
    ...
    public void testDetectDuplicates() {
        ...
        DetectDuplicateInCSVExample.detectDuplicates(testFilePath);  // Run the detection logic
