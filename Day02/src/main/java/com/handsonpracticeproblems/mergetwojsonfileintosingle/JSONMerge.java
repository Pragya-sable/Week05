package com.handsonpracticeproblems.mergetwojsonfileintosingle;
...
public class JSONMerge {
    public static void main(String[] args) {
        String jsonFile1 = "src/main/java/com/handsonpracticeproblems/mergetwojsonfileintosingle/File1.json";
        String jsonFile2 = "src/main/java/com/handsonpracticeproblems/mergetwojsonfileintosingle/File2.json";
